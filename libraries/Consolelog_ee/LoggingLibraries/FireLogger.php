<?php
    ...
    if (!defined('FIRELOGGER_ENABLED')) define('FIRELOGGER_ENABLED', true);
    ...
    class FireLogger {
        ...
        public static $enabled = FIRELOGGER_ENABLED; // enabled by default, but see the code executed after class
